...
When you create a new project, you have to configure PyCharm to use the `pyenv` Python interpreter. You need to select `Previously configured interpreter`, then click the three dots `...`, select `System Interpreter`, and navigate to ``
